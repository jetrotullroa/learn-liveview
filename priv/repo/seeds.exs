...
#
#     LiveViewApps.Repo.insert!(%LiveViewApps.SomeSchema{})
#
# We recommend using the bang functions (`insert!`, `update!`
# and so on) as they will fail if something goes wrong.

alias LiveViewApps.Repo
alias LiveViewApps.Boats.Boat
...
alias LiveViewApps.Servers.Server
...
alias LiveViewApps.Donations.Donation
...
alias LiveViewApps.Athletes.Athlete
...
alias LiveViewApps.PizzaOrders.PizzaOrder
