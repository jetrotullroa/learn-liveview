defmodule LiveViewAppsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveViewAppsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveViewAppsWeb.Gettext, "errors", msg, opts)
    end
  end
