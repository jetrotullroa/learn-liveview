defmodule LiveViewAppsWeb.SandboxLive do
  ...
  def handle_event("calculate", params, socket) do
    ...
    weight = LiveViewApps.Sandbox.calculate_weight(l, w, d)
  ...
  def handle_event("get-quote", _params, socket) do
    price = LiveViewApps.Sandbox.calculate_price(socket.assigns.weight)
